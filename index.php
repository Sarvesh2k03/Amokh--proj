...
<html lang="en">
	...
	?>
		...
		<!-- One -->
			<section id="one" class="wrapper style1 align-center">
				<div class="container">
					<header>
						<h2>E-Grat</h2>
						<p>"Revolutionize your agricultural trade with us"</p>
					</header>
					<div class="row 200%">
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">E-Grat &copy; </h3>
		<!--	<div class="logo">
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">E-Grat Fam<span>Vormir</span></p>
			</div>
			<div>
		...
		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About E-Grat</b></span>
				E-Grat is e-commerce trading platform for grains & grocerries...
			</p>
